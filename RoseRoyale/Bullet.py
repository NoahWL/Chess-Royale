...
class PistolBullet:
    ...
    def drawBullet(self):
        ...
        if abs(self.startPosX - self.posX) < 1800:
            ...
            if checkTerrainCollision(self, self.terrainList):
                return False
            
            if checkPlayerCollision(self, self.terrain.players):
                return False
    ...
    def drawBullet(self):
        ...
        if self.collided:
            ...
            if abs(self.startPosX - self.posX) < 2000:
                ...
                def doHit():
                    for i in range(15):
                        pellet = RPGPellets(self.win, self.terrain, self.posX + magicNum, self.posY, self.owner)
